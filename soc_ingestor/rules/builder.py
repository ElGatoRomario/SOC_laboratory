...
def build_all_rules(cfg: dict) -> list:
    ...
    rules = [
        ...
        _r("soc-ia-002", "Login from Known Malicious IP", "query",
           'event.outcome: "success" and event.category: "authentication" and source.ip: ('
           + mal_ips + ')',
        ...
        _r("soc-ia-003", "Admin Login from External IP", "query",
           'event.outcome: "success" and user.name: ('
           + adm_users
           + ') and not source.ip: 10.* and not source.ip: 172.16.* and not source.ip: 192.168.*',
        ...
        _r("soc-ex-001", "Suspicious PowerShell Encoded Command", "query",
           ...
           '(process.command_line: *-enc* or process.command_line: *hidden* or '
           'process.command_line: *bypass* or process.command_line: *IEX* or '
        ...
        _r("soc-ex-002", "CMD Reconnaissance Commands", "query",
           ...
           '(process.command_line: *whoami* or process.command_line: *net\\ user* or '
           'process.command_line: *net\\ localgroup* or process.command_line: *nltest* or '
        ...
        _r("soc-ex-003", "LOLBin Proxy Execution", "query",
           '(process.name: "mshta.exe" or process.name: "rundll32.exe" or '
           'process.name: "regsvr32.exe") and '
           '(process.command_line: *http* or process.command_line: *javascript* or '
           'process.command_line: *vbscript* or process.command_line: *scrobj*)',
        ...
        _r("soc-pe-001", "Registry Run Key Modification", "query",
           'process.command_line: *reg* and process.command_line: *add* and '
        ...
        _r("soc-pe-003", "Suspicious Service Installation", "query",
           'process.command_line: *sc\\ create* and '
           '(process.command_line: *Temp* or process.command_line: *ProgramData* or '
           'process.command_line: *Public*)',
        ...
        _r("soc-ca-001", "Credential Dumping - Mimikatz / LSASS", "query",
           'process.command_line: (*mimikatz* or *sekurlsa* or *lsadump* or '
           '*procdump*lsass* or *reg\\ save*SAM* or *reg\\ save*SYSTEM* or *ntdsutil*)',
        ...
        _r("soc-di-001", "Network Reconnaissance Tools", "query",
           '(process.name: ("nmap" or "nmap.exe" or "masscan" or "masscan.exe")) or '
           '(process.command_line: (*arp\\ -a* or *netstat\\ -an* or *net\\ view*))',
        ...
        _r("soc-lm-001", "Lateral Movement via PsExec / SMB", "query",
           'process.command_line: (*psexec* or *net\\ use*C$* or '
           '*net\\ use*IPC$* or *wmic*/node*)',
        ...
        _r("soc-lm-002", "External RDP Connection", "query",
           'destination.port: 3389 and not source.ip: 10.* and '
           'not source.ip: 172.16.* and not source.ip: 192.168.*',
        ...
        _r("soc-de-001", "Certutil File Download", "query",
           ...
           '(process.command_line: *urlcache* or process.command_line: *encode* or '
           'process.command_line: *decode*)',
        ...
        _r("soc-de-002", "Shadow Copy Deletion - Ransomware", "query",
           'process.command_line: (*vssadmin*delete*shadow* or '
           '*bcdedit*recoveryenabled*No* or *wbadmin*delete*catalog*)',
        ...
        _r("soc-cc-001", "Outbound to Known Malicious IP", "query",
           'network.direction: "outbound" and destination.ip: (' + mal_ips + ')',
        ...
        _r("soc-cc-003", "Connection on Suspicious Port", "query",
           'network.direction: "outbound" and destination.port: (' + sus_ports + ')',
        ...
        _r("soc-xf-001", "Large Outbound Data Transfer", "query",
           'network.direction: "outbound" and source.bytes >= 10000000 and '
           'not destination.ip: 10.* and not destination.ip: 172.16.* and '
           'not destination.ip: 192.168.*',
        ...
        _r("soc-fw-001", "Inbound Blocked from Malicious IP", "query",
           ...
           'event.action: ("denied" or "dropped" or "reset") and '
           'source.ip: (' + mal_ips + ')',
        ...
        _r("soc-fw-002", "Outbound to Malicious IP Allowed", "query",
           'network.direction: "outbound" and event.action: "allowed" and '
           'destination.ip: (' + mal_ips + ')',
